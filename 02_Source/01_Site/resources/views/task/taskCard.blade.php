...
@section('styles')
<link rel="stylesheet" href="./css/task/taskcard.css">
@endsection
...
<div class="kt-portlet__head">
    <div class="kt-portlet__head-label">
        <a href="#" class="btn btn-icon btn-label-instagram btn-pill btn-icon-md">
            <div class="triangle">
                <span>H</span>
            </div>
        </a>
...
<div class="kt-scroll" data-scroll="true" style="height: 700px">
<div class="kt-task-item fat danger">
    <div class="row">
    ...
    <div class="row kt-item-date">
        ...
        <div class="col-lg-6 task-end-date">
            <p style="float: right">5.11.</p>
        </div>
    </div>
</div>
<div class="kt-task-item fat grey">
    <div class="row">
        <div class="col-lg-2 task-status">
            <i class="flaticon2-arrow lg"></i>
        </div>
    ...
    <div class="kt-space-10"></div>
    <div class="progress" style="height: 6px;">
        <div class="progress-bar bg-warning" role="progressbar" style="width: 60%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
    <div class="kt-space-5"></div>
    <div class="row kt-item-date">
        <div class="col-lg-6 task-start-date">
...
<div class="kt-task-item thin grey">
    <div class="row">
        <div class="col-lg-2 task-status">
...
<div class="kt-task-item thin grey selected">
    <div class="row">
        <div class="col-lg-2 task-status">
    ...
    <div class="progress" style="height: 6px;">
        ...
        <div class="progress-bar bg-dark" role="progressbar" style="width: 50%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
    </div>
    <div class="kt-space-5"></div>
    <div class="row kt-item-date">
        <div class="col-lg-6 task-start-date">
...
<div class="kt-task-item medium grey">
    <div class="row">
        <div class="col-lg-2 task-status">
...
<div class="row kt-task-extand-item">
    ...
    <div class="col-lg-4">
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="col-lg-6">
                <span class="kt-badge kt-badge--default kt-badge--md kt-badge--rounded">8</span>
            </div>
        </div>
...
<div class="row kt-task-extand-item selected" id = "kt_quick_panel_toggler_btn">
    <div class="col-lg-8 extand-main-content">
        <div class="kt-extend-part fat">
            <div class="row">
                <div class="col-lg-2 task-status">
            ...
            <div class="kt-space-10"></div>
            <div class="progress" style="height: 6px;">
                <div class="progress-bar bg-danger" role="progressbar" style="width: 70%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <div class="kt-space-5"></div>
            <div class="row kt-item-date">
                <div class="col-lg-6 task-start-date">
...
<div class="row kt-task-extand-item">
    <div class="col-lg-8 extand-main-content">
        <div class="kt-extend-part medium">
            <div class="row">
                <div class="col-lg-2 task-status">
                    <i class="flaticon2-arrow lg"></i>
                </div>
...
<div class="col-lg-2">
    <div class="kt-portlet" id="kt_final_sub_task">
        <div class="kt-portlet__head">
            <div class="kt-portlet__head-label">
        ...
        <div class="kt-portlet__body">
            <div class="kt-scroll" data-scroll="true" style="height: 250px">
                <div class="kt-final-sub-task-item thin grey">
                    <div class="row">
                        <div class="col-lg-2 task-status">
                            <i class="fa fa-pause"></i>
                        </div>
